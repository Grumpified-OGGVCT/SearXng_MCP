...
class RealTimeDataManager:
    ...
    TIME_SENSITIVE_KEYWORDS = [
        'now', 'current', 'today', 'latest', 'recent', 'breaking',
        'live', 'real-time', 'update', 'news', 'price', 'stock',
        'weather', 'traffic', 'score', 'trending', 'status',
        'happening', 'ongoing', 'active', 'emergency'
    ]
    
    # High-freshness categories
    HIGH_FRESHNESS_CATEGORIES = [
        'news', 'social', 'finance', 'sports', 'weather'
    ]
    ...
    def get_freshness_badge(self, 
                           ...
                           age_seconds: Optional[float] = None) -> str:
        """
    ...
    def is_time_sensitive(self, 
        ...
        date_patterns = [
            r'\btoday\b', r'\bthis\s+(?:week|month|year)\b',
    ...
    def _extract_timestamp(self, result: Dict[str, Any]) -> Optional[datetime]:
    ...
    def _classify_query_type(self, 
        ...
        dynamic_keywords = ['news', 'breaking', 'latest', 'update', 'trending', 
                          'price', 'stock', 'weather', 'traffic']
        ...
        static_keywords = ['history', 'definition', 'biography', 'meaning', 
                         'what is', 'who is', 'who was', 'when was']
